...
import static apps.developer.fastgrocery.grocery_activity.Search.search;
import static apps.developer.fastgrocery.grocery_fragment.ItemListFragment.itemListFragment;


public class SearchProductListAdapter extends RecyclerView.Adapter<SearchProductListAdapter.SearchProductViewHolder>{
    ...
    public SearchProductListAdapter(Context context, List<ProductDataList> productlist) {
        this.productlist = productlist;
        this.context = context;
        sessionManager=new SessionManager(context);
    }

    public SearchProductListAdapter(Search search, Context context, List<ProductDataList> productlist) {
        this.search = search;
        this.productlist = productlist;
        this.context = context;
        sessionManager=new SessionManager(context);
