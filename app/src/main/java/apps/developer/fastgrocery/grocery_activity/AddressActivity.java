...
public class AddressActivity extends AppCompatActivity {
    ...
    private User user;
    private TextInputEditText edUsername,edHoousno,edSociety,edLandmark,edPinno,edAlternatmob;
    ...
    private void UpdateUser() {
        ...
        apiService.getUpdateProfile((JsonObject) jsonParser.parse(jsonObject.toString())).enqueue(new Callback<LoginResponseData>() {
            ...
            public void onResponse(Call<LoginResponseData> call, Response<LoginResponseData> response) {
                ...
                Toast.makeText(AddressActivity.this, "" + response.body().getResponseMsg(), Toast.LENGTH_LONG).show();
        ...
        apiService.getArea(jsonObject).enqueue(new Callback<AreaResponseData>() {
            ...
            public void onResponse(Call<AreaResponseData> call, Response<AreaResponseData> response) {
                ...
                if (response.body().getResult().contains("true")){
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(AddressActivity.this, android.R.layout.simple_dropdown_item_1line, Arealist);
